...
Ce repo contient un `render.yaml` (Blueprint) qui déclare un site statique (`marche-adeps-thuin`).
...
4. L'URL publique sera `https://marche-adeps-thuin.onrender.com` (ou un nom disponible proche si celui-ci est déjà pris).
